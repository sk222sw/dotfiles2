return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>ou", function() require("opencode").command("messages_half_page_up") end,
      { desc = "Messages half page up" })
    vim.keymap.set("n", "<leader>od", function() require("opencode").command("messages_half_page_down") end,
